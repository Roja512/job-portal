      ...
      <div className='shadow py-4'>
        <div className='px-5 flex justify-between items-center'>
            ...
            <div className='flex items-center gap-3'>
                <p className='max-sm:hidden'>Welcome, JobApp</p>
       ...
       <div className='flex items-start'>
        ...
        {/* Left Sidebar with option to add job, manage jobs,view applivcation */}

        <div className='inline-block min-h-screen border-r-2 border border-gray-200'>
